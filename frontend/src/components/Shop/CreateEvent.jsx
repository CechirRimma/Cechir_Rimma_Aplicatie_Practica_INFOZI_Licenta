 ...
 const minEndDate = startDate ? new Date(startDate.getTime() + 3 * 24 * 60 * 60 * 1000).toISOString().slice(0,10) : "";
  ...
  return (
    <div className="w-[90%] 800px:w-[50%] bg-white  shadow h-[80vh] rounded-[4px] p-3 overflow-y-scroll">
      <h5 className="text-[30px] font-Poppins text-center">Crează Eveniment</h5>
      {/* create event form */}
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          >
            <option value="Alege Categorie">Alege Categorie</option>
            {categoriesData &&
        ...
        <div>
          <label className="pb-2">
            Incepe la   <span className="text-red-500">*</span>
          </label>
          <input
            type="date"
            name="price"
        ...
        <div>
          <label className="pb-2">
            Se termină la <span className="text-red-500">*</span>
          </label>
          <input
            type="date"
            name="price"
