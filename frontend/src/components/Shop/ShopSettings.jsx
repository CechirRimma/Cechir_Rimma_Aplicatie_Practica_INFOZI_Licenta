...
const ShopSettings = () => {
  ...
  const updateHandler = async (e) => {
    ...
    await axios.put(`${server}/shop/update-seller-info`, {
        ...
        toast.success("Informațiile magazinului au fost actualizate cu succes!");
        dispatch(loadSeller());
    }).catch((error)=> {
        toast.error(error.response.data.message);
    })
        ...
        >
          <div className="w-[100%] flex items-center flex-col 800px:w-[50%] mt-5">
            <div className="w-full pl-[3%]">
              <label className="block pb-2">Nume Magazin</label>
            </div>
            <input
              type="name"
          ...
          <div className="w-[100%] flex items-center flex-col 800px:w-[50%] mt-5">
            <div className="w-full pl-[3%]">
              <label className="block pb-2">Descriere</label>
            </div>
            <input
              type="name"
              placeholder={`${
          ...
          <div className="w-[100%] flex items-center flex-col 800px:w-[50%] mt-5">
            <div className="w-full pl-[3%]">
              <label className="block pb-2">Numar de Telefon </label>
            </div>
            <input
              type="number"
