        ...
        <div className="w-full block 800px:flex items-center justify-between">
          ...
          <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
            ...
            <Link to="/admin-sellers">
              <h5 className="pt-4 pl-2 text-[#077f9c]">Vizualizare vânzători</h5>
            </Link>
          </div>
          ...
          <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
            ...
            <Link to="/admin-orders">
              <h5 className="pt-4 pl-2 text-[#077f9c]">Vizualizare comenzi </h5>
            </Link>
          </div>
        </div>
  
        <br />
        <h3 className="text-[22px] font-Poppins pb-2">Ultimele comenzi</h3>
