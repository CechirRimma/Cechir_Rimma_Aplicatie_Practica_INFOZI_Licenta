    ...
    <>
      <div className={`${styles.section}`}>
        <div className="hidden 800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between">
          <div>
            <Link to="/">
              <img className="h-20 w-36 bg-transparent"
                src="https://s3u.tmimgcdn.com/800x0/u8265365/2f29adc716c7d046dcbbfddea061ae45.jpg"
                alt=""
              />
            </Link>
          </div>
      ...
      <div
        ...
        } transition hidden 800px:flex items-center justify-between w-full bg-[#7a7a7a] h-[70px]`}
      >
        <div
          ...
          <div>
            <Link to="/">
              <img 
                src="https://s3u.tmimgcdn.com/800x0/u8265365/2f29adc716c7d046dcbbfddea061ae45.jpg"
                alt=""
                className="cursor-pointer h-15 w-24 bg-transparent"
              />
            </Link>
          </div>
          <div>
          ...
          >
            <div className="fixed w-[70%] bg-[#fff] h-screen top-0 left-0 z-10 overflow-y-scroll">
              ...
              <div className={`${styles.button} ml-4 !rounded-[4px]`}>
                <Link to="/shop-create">
                  <h1 className="text-[#fff] flex items-center">
                  Înregistrează-te ca vânzător <IoIosArrowForward className="ml-1" />
                  </h1>
                </Link>
              </div>
              <br />
